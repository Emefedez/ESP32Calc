...
inline constexpr const char* kModeLabels[] = {"STANDARD", "SOLVER", "MATRIX", "CONST", "CALCULUS", "SD APPS"};
...
inline constexpr int kModeSelectorY = 28;
inline constexpr int kModeSelectorRowHeight = 14;
