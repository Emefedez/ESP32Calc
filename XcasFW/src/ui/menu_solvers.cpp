...
inline constexpr SolverTemplate kTemplates[] = {
    ...
    {1, "10", "System 2x2", "system(x+y=;x-y=,[x,y])", 11, "system equations"},
    {1, "11", "System 3x3", "system(x+y+z=;x-y+z=;x+y-z=,[x,y,z])", 13, "system equations"},
    {1, "12", "Blank 2 eq", "system(=;=,[x,y])", 9, "system blank"},
    {1, "13", "Blank 3 eq", "system(=;=;=,[x,y,z])", 9, "system blank"},
