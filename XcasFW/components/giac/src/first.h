...
#define CIN (::giac::null_istream())
#define COUT (::giac::null_ostream())
#define CERR (::giac::null_ostream())
#define CLOCK() 0
#define CLOCK_T int
#else
#define CIN std::cin
...
#ifdef DOUBLEVAL 
#ifndef GIAC_ESP32_KEEP_STATIC_BUILTINS
